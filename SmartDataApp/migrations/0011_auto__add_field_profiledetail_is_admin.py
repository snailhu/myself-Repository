...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfileDetail.is_admin'
        db.add_column(u'SmartDataApp_profiledetail', 'is_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfileDetail.is_admin'
        db.delete_column(u'SmartDataApp_profiledetail', 'is_admin')
