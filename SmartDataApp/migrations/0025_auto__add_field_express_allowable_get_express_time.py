...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Express.allowable_get_express_time'
        db.add_column(u'SmartDataApp_express', 'allowable_get_express_time',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Express.allowable_get_express_time'
        db.delete_column(u'SmartDataApp_express', 'allowable_get_express_time')
