...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Housekeeping_items.community'
        db.add_column(u'SmartDataApp_housekeeping_items', 'community',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.Community'], null=True),
                      keep_default=False)

        # Adding field 'Complaints.community'
        db.add_column(u'SmartDataApp_complaints', 'community',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.Community'], null=True),
                      keep_default=False)

        # Adding field 'Repair.community'
        db.add_column(u'SmartDataApp_repair', 'community',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.Community'], null=True),
                      keep_default=False)

        # Adding field 'Express.community'
        db.add_column(u'SmartDataApp_express', 'community',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.Community'], null=True),
                      keep_default=False)

        # Adding field 'Housekeeping.community'
        db.add_column(u'SmartDataApp_housekeeping', 'community',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.Community'], null=True),
                      keep_default=False)

        # Adding field 'Repair_item.community'
        db.add_column(u'SmartDataApp_repair_item', 'community',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.Community'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Housekeeping_items.community'
        db.delete_column(u'SmartDataApp_housekeeping_items', 'community_id')

        # Deleting field 'Complaints.community'
        db.delete_column(u'SmartDataApp_complaints', 'community_id')

        # Deleting field 'Repair.community'
        db.delete_column(u'SmartDataApp_repair', 'community_id')

        # Deleting field 'Express.community'
        db.delete_column(u'SmartDataApp_express', 'community_id')

        # Deleting field 'Housekeeping.community'
        db.delete_column(u'SmartDataApp_housekeeping', 'community_id')

        # Deleting field 'Repair_item.community'
        db.delete_column(u'SmartDataApp_repair_item', 'community_id')
