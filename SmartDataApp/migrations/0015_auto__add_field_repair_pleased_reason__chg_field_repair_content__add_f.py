...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repair.pleased_reason'
        db.add_column(u'SmartDataApp_repair', 'pleased_reason',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)


        # Changing field 'Repair.content'
        db.alter_column(u'SmartDataApp_repair', 'content', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
        # Adding field 'Complaints.pleased_reason'
        db.add_column(u'SmartDataApp_complaints', 'pleased_reason',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Repair.pleased_reason'
        db.delete_column(u'SmartDataApp_repair', 'pleased_reason')


        # User chose to not deal with backwards NULL issues for 'Repair.content'
        raise RuntimeError("Cannot reverse this migration. 'Repair.content' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Repair.content'
        db.alter_column(u'SmartDataApp_repair', 'content', self.gf('django.db.models.fields.CharField')(max_length=250))
        # Deleting field 'Complaints.pleased_reason'
        db.delete_column(u'SmartDataApp_complaints', 'pleased_reason')


        # User chose to not deal with backwards NULL issues for 'Complaints.content'
        raise RuntimeError("Cannot reverse this migration. 'Complaints.content' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Complaints.content'
        db.alter_column(u'SmartDataApp_complaints', 'content', self.gf('django.db.models.fields.CharField')(max_length=250))
