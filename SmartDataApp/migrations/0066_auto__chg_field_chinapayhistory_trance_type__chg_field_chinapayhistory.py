...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChinaPayHistory.trance_type'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'trance_type', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'ChinaPayHistory.sign_method'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'sign_method', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'ChinaPayHistory.mer_abbr'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'mer_abbr', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'ChinaPayHistory.mer_id'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'mer_id', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'ChinaPayHistory.charset'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'charset', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'ChinaPayHistory.version'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'version', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'ChinaPayHistory.qid'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'qid', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'ChinaPayHistory.resp_msg'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'resp_msg', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'ChinaPayHistory.trace_time'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'trace_time', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'ChinaPayHistory.resp_time'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'resp_time', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'ChinaPayHistory.trance_number'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'trance_number', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'ChinaPayHistory.resp_code'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'resp_code', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'ChinaPayHistory.signature'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'signature', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'ChinaPayHistory.order_number'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'order_number', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'ChinaPayHistory.trance_type'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'trance_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'ChinaPayHistory.sign_method'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'sign_method', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'ChinaPayHistory.mer_abbr'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'mer_abbr', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'ChinaPayHistory.mer_id'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'mer_id', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'ChinaPayHistory.charset'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'charset', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'ChinaPayHistory.version'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'version', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'ChinaPayHistory.qid'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'qid', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'ChinaPayHistory.resp_msg'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'resp_msg', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'ChinaPayHistory.trace_time'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'trace_time', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'ChinaPayHistory.resp_time'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'resp_time', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'ChinaPayHistory.trance_number'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'trance_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'ChinaPayHistory.resp_code'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'resp_code', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'ChinaPayHistory.signature'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'signature', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'ChinaPayHistory.order_number'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'order_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
