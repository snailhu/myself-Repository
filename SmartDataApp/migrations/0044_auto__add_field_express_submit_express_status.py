...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Express.submit_express_status'
        db.add_column(u'SmartDataApp_express', 'submit_express_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Express.submit_express_status'
        db.delete_column(u'SmartDataApp_express', 'submit_express_status')
