...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Wallet'
        db.create_table(u'SmartDataApp_wallet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.ProfileDetail'], null=True)),
            ('money_sum', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=19, decimal_places=6)),
            ('grade_sum', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'SmartDataApp', ['Wallet'])

        # Adding model 'Transaction'
        db.create_table(u'SmartDataApp_transaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('money_num', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=19, decimal_places=6)),
            ('grade_num', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('remark', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('wallet_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.Wallet'], null=True)),
        ))
        db.send_create_signal(u'SmartDataApp', ['Transaction'])

        # Adding field 'ProfileDetail.car_number'
        db.add_column(u'SmartDataApp_profiledetail', 'car_number',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'SmartDataApp_wallet')

        # Deleting model 'Transaction'
        db.delete_table(u'SmartDataApp_transaction')

        # Deleting field 'ProfileDetail.car_number'
        db.delete_column(u'SmartDataApp_profiledetail', 'car_number')
