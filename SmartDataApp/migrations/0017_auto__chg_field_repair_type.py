...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Repair.type'
        db.alter_column(u'SmartDataApp_repair', 'type', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Repair.type'
        db.alter_column(u'SmartDataApp_repair', 'type', self.gf('django.db.models.fields.CharField')(max_length=20))
