...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Complaints.author_detail'
        db.add_column(u'SmartDataApp_complaints', 'author_detail',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.ProfileDetail'], null=True),
                      keep_default=False)

        # Adding field 'Repair.author_detail'
        db.add_column(u'SmartDataApp_repair', 'author_detail',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.ProfileDetail'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Complaints.author_detail'
        db.delete_column(u'SmartDataApp_complaints', 'author_detail_id')

        # Deleting field 'Repair.author_detail'
        db.delete_column(u'SmartDataApp_repair', 'author_detail_id')
