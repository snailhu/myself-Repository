...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Complaints.complete_date'
        db.add_column(u'SmartDataApp_complaints', 'complete_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Repair.create_date'
        db.add_column(u'SmartDataApp_repair', 'create_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Repair.complete_date'
        db.add_column(u'SmartDataApp_repair', 'complete_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Express.arrive_date'
        db.add_column(u'SmartDataApp_express', 'arrive_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Express.complete_date'
        db.add_column(u'SmartDataApp_express', 'complete_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Housekeeping.apply_date'
        db.add_column(u'SmartDataApp_housekeeping', 'apply_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Complaints.complete_date'
        db.delete_column(u'SmartDataApp_complaints', 'complete_date')

        # Deleting field 'Repair.create_date'
        db.delete_column(u'SmartDataApp_repair', 'create_date')

        # Deleting field 'Repair.complete_date'
        db.delete_column(u'SmartDataApp_repair', 'complete_date')

        # Deleting field 'Express.arrive_date'
        db.delete_column(u'SmartDataApp_express', 'arrive_date')

        # Deleting field 'Express.complete_date'
        db.delete_column(u'SmartDataApp_express', 'complete_date')

        # Deleting field 'Housekeeping.apply_date'
        db.delete_column(u'SmartDataApp_housekeeping', 'apply_date')
