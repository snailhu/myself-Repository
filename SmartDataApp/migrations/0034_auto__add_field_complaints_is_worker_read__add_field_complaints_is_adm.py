...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Complaints.is_worker_read'
        db.add_column(u'SmartDataApp_complaints', 'is_worker_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Complaints.is_admin_read'
        db.add_column(u'SmartDataApp_complaints', 'is_admin_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Repair.is_worker_read'
        db.add_column(u'SmartDataApp_repair', 'is_worker_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Repair.is_admin_read'
        db.add_column(u'SmartDataApp_repair', 'is_admin_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Express.is_worker_read'
        db.add_column(u'SmartDataApp_express', 'is_worker_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Express.is_admin_read'
        db.add_column(u'SmartDataApp_express', 'is_admin_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Housekeeping.is_worker_read'
        db.add_column(u'SmartDataApp_housekeeping', 'is_worker_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Housekeeping.is_admin_read'
        db.add_column(u'SmartDataApp_housekeeping', 'is_admin_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Complaints.is_worker_read'
        db.delete_column(u'SmartDataApp_complaints', 'is_worker_read')

        # Deleting field 'Complaints.is_admin_read'
        db.delete_column(u'SmartDataApp_complaints', 'is_admin_read')

        # Deleting field 'Repair.is_worker_read'
        db.delete_column(u'SmartDataApp_repair', 'is_worker_read')

        # Deleting field 'Repair.is_admin_read'
        db.delete_column(u'SmartDataApp_repair', 'is_admin_read')

        # Deleting field 'Express.is_worker_read'
        db.delete_column(u'SmartDataApp_express', 'is_worker_read')

        # Deleting field 'Express.is_admin_read'
        db.delete_column(u'SmartDataApp_express', 'is_admin_read')

        # Deleting field 'Housekeeping.is_worker_read'
        db.delete_column(u'SmartDataApp_housekeeping', 'is_worker_read')

        # Deleting field 'Housekeeping.is_admin_read'
        db.delete_column(u'SmartDataApp_housekeeping', 'is_admin_read')
