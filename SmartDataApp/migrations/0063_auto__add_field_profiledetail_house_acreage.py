...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfileDetail.house_acreage'
        db.add_column(u'SmartDataApp_profiledetail', 'house_acreage',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=6, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfileDetail.house_acreage'
        db.delete_column(u'SmartDataApp_profiledetail', 'house_acreage')
