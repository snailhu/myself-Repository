...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Park_fee.pay_status'
        db.add_column(u'SmartDataApp_park_fee', 'pay_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Park_fee.pay_status'
        db.delete_column(u'SmartDataApp_park_fee', 'pay_status')
    ...
    models = {
        ...
        u'SmartDataApp.park_fee': {
            ...
            'pay_status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'pay_type': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True'}),
