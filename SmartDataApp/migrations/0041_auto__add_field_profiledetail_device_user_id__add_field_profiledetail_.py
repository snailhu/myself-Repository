...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfileDetail.device_user_id'
        db.add_column(u'SmartDataApp_profiledetail', 'device_user_id',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=250, null=True),
                      keep_default=False)

        # Adding field 'ProfileDetail.device_chanel_id'
        db.add_column(u'SmartDataApp_profiledetail', 'device_chanel_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfileDetail.device_user_id'
        db.delete_column(u'SmartDataApp_profiledetail', 'device_user_id')

        # Deleting field 'ProfileDetail.device_chanel_id'
        db.delete_column(u'SmartDataApp_profiledetail', 'device_chanel_id')
