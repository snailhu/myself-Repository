...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfileDetail.device_type'
        db.add_column(u'SmartDataApp_profiledetail', 'device_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfileDetail.device_type'
        db.delete_column(u'SmartDataApp_profiledetail', 'device_type')
