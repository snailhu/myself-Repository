...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Complaints.complete_time'
        db.add_column(u'SmartDataApp_complaints', 'complete_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Repair.complete_time'
        db.add_column(u'SmartDataApp_repair', 'complete_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Express.complete_time'
        db.add_column(u'SmartDataApp_express', 'complete_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Complaints.complete_time'
        db.delete_column(u'SmartDataApp_complaints', 'complete_time')

        # Deleting field 'Repair.complete_time'
        db.delete_column(u'SmartDataApp_repair', 'complete_time')

        # Deleting field 'Express.complete_time'
        db.delete_column(u'SmartDataApp_express', 'complete_time')
