...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Housekeeping_item'
        db.delete_table(u'SmartDataApp_housekeeping_item')

        # Adding model 'Housekeeping_items'
        db.create_table(u'SmartDataApp_housekeeping_items', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('content', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('price', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('remarks', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
        ))
        db.send_create_signal(u'SmartDataApp', ['Housekeeping_items'])


    def backwards(self, orm):
        # Adding model 'Housekeeping_item'
        db.create_table(u'SmartDataApp_housekeeping_item', (
            ('price', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('content', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('item', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('remarks', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
        ...
        db.send_create_signal(u'SmartDataApp', ['Housekeeping_item'])

        # Deleting model 'Housekeeping_items'
        db.delete_table(u'SmartDataApp_housekeeping_items')
