...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Park_fee.position_num'
        db.add_column(u'SmartDataApp_park_fee', 'position_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Park_fee.order_number'
        db.add_column(u'SmartDataApp_park_fee', 'order_number',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Park_fee.position_num'
        db.delete_column(u'SmartDataApp_park_fee', 'position_num')

        # Deleting field 'Park_fee.order_number'
        db.delete_column(u'SmartDataApp_park_fee', 'order_number')
    ...
    models = {
        u'SmartDataApp.car_washing': {
            ...
            'total_money': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '6', 'decimal_places': '2'}),
