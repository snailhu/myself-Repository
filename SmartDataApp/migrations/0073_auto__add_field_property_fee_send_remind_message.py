...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Property_fee.send_remind_message'
        db.add_column(u'SmartDataApp_property_fee', 'send_remind_message',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Property_fee.send_remind_message'
        db.delete_column(u'SmartDataApp_property_fee', 'send_remind_message')
