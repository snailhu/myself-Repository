...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.order_number'
        db.add_column(u'SmartDataApp_transaction', 'order_number',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.order_number'
        db.delete_column(u'SmartDataApp_transaction', 'order_number')
