...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Housekeeping'
        db.create_table(u'SmartDataApp_housekeeping', (
        ...
        db.send_create_signal(u'SmartDataApp', ['Housekeeping'])


    def backwards(self, orm):
        # Deleting model 'Housekeeping'
        db.delete_table(u'SmartDataApp_housekeeping')
