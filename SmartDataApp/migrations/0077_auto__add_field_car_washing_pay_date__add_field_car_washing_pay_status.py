...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Car_Washing.pay_date'
        db.add_column(u'SmartDataApp_car_washing', 'pay_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Car_Washing.pay_status'
        db.add_column(u'SmartDataApp_car_washing', 'pay_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Car_Washing.pay_date'
        db.delete_column(u'SmartDataApp_car_washing', 'pay_date')

        # Deleting field 'Car_Washing.pay_status'
        db.delete_column(u'SmartDataApp_car_washing', 'pay_status')
