...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Housekeeping.time'
        db.add_column(u'SmartDataApp_housekeeping', 'time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Housekeeping.status'
        db.add_column(u'SmartDataApp_housekeeping', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Housekeeping.pleased'
        db.add_column(u'SmartDataApp_housekeeping', 'pleased',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Housekeeping.pleased_reason'
        db.add_column(u'SmartDataApp_housekeeping', 'pleased_reason',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding field 'Housekeeping.handler'
        db.add_column(u'SmartDataApp_housekeeping', 'handler',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Housekeeping.time'
        db.delete_column(u'SmartDataApp_housekeeping', 'time')

        # Deleting field 'Housekeeping.status'
        db.delete_column(u'SmartDataApp_housekeeping', 'status')

        # Deleting field 'Housekeeping.pleased'
        db.delete_column(u'SmartDataApp_housekeeping', 'pleased')

        # Deleting field 'Housekeeping.pleased_reason'
        db.delete_column(u'SmartDataApp_housekeeping', 'pleased_reason')

        # Deleting field 'Housekeeping.handler'
        db.delete_column(u'SmartDataApp_housekeeping', 'handler_id')
