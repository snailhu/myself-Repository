...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Express.get_date'
        db.delete_column(u'SmartDataApp_express', 'get_date')
        ...
        # Adding field 'Express.submit_get_date'
        db.add_column(u'SmartDataApp_express', 'submit_get_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Express.get_date'
        db.add_column(u'SmartDataApp_express', 'get_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)
        ...
        # Deleting field 'Express.submit_get_date'
        db.delete_column(u'SmartDataApp_express', 'submit_get_date')
