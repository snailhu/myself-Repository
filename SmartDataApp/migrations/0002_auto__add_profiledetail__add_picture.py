...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'SmartDataApp_profiledetail', (
            ...
            ('cell_phone', self.gf('django.db.models.fields.CharField')(max_length=11, null=True)),
        ))
        db.send_create_signal(u'SmartDataApp', ['ProfileDetail'])

        # Adding model 'Picture'
        db.create_table(u'SmartDataApp_picture', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('src', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True)),
            ('timestamp_add', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ...
        db.send_create_signal(u'SmartDataApp', ['Picture'])


    def backwards(self, orm):
        # Deleting model 'ProfileDetail'
        db.delete_table(u'SmartDataApp_profiledetail')

        # Deleting model 'Picture'
        db.delete_table(u'SmartDataApp_picture')
