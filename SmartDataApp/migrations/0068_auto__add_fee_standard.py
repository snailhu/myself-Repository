...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Fee_standard'
        db.create_table(u'SmartDataApp_fee_standard', (
            ...
            ('fee', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=6, decimal_places=2)),
        ))
        db.send_create_signal(u'SmartDataApp', ['Fee_standard'])


    def backwards(self, orm):
        # Deleting model 'Fee_standard'
        db.delete_table(u'SmartDataApp_fee_standard')
