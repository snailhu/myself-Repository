...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Complaints.is_read'
        db.add_column(u'SmartDataApp_complaints', 'is_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Repair.is_read'
        db.add_column(u'SmartDataApp_repair', 'is_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Express.is_read'
        db.add_column(u'SmartDataApp_express', 'is_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Housekeeping.is_read'
        db.add_column(u'SmartDataApp_housekeeping', 'is_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Complaints.is_read'
        db.delete_column(u'SmartDataApp_complaints', 'is_read')

        # Deleting field 'Repair.is_read'
        db.delete_column(u'SmartDataApp_repair', 'is_read')

        # Deleting field 'Express.is_read'
        db.delete_column(u'SmartDataApp_express', 'is_read')

        # Deleting field 'Housekeeping.is_read'
        db.delete_column(u'SmartDataApp_housekeeping', 'is_read')
