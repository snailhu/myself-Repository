...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Property_fee'
        db.create_table(u'SmartDataApp_property_fee', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.ProfileDetail'], null=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('pay_status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('valid_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True)),
            ('deadline', self.gf('django.db.models.fields.DateField')(null=True)),
        ))
        db.send_create_signal(u'SmartDataApp', ['Property_fee'])


    def backwards(self, orm):
        # Deleting model 'Property_fee'
        db.delete_table(u'SmartDataApp_property_fee')
