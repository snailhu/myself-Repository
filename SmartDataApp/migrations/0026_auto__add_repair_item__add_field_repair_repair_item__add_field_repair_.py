...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'SmartDataApp', ['Repair_item'])

        # Adding field 'Repair.repair_item'
        db.add_column(u'SmartDataApp_repair', 'repair_item',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Repair.price'
        db.add_column(u'SmartDataApp_repair', 'price',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Repair_item'
        db.delete_table(u'SmartDataApp_repair_item')

        # Deleting field 'Repair.repair_item'
        db.delete_column(u'SmartDataApp_repair', 'repair_item')

        # Deleting field 'Repair.price'
        db.delete_column(u'SmartDataApp_repair', 'price')
