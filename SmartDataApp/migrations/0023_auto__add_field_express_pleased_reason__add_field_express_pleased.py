...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Express.pleased_reason'
        db.add_column(u'SmartDataApp_express', 'pleased_reason',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding field 'Express.pleased'
        db.add_column(u'SmartDataApp_express', 'pleased',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Express.pleased_reason'
        db.delete_column(u'SmartDataApp_express', 'pleased_reason')

        # Deleting field 'Express.pleased'
        db.delete_column(u'SmartDataApp_express', 'pleased')
