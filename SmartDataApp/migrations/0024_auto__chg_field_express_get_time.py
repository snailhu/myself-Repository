...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Express.get_time'
        db.alter_column(u'SmartDataApp_express', 'get_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Express.get_time'
        db.alter_column(u'SmartDataApp_express', 'get_time', self.gf('django.db.models.fields.DateTimeField')())
