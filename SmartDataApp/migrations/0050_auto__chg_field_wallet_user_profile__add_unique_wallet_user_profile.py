...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Wallet.user_profile'
        db.alter_column(u'SmartDataApp_wallet', 'user_profile_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['SmartDataApp.ProfileDetail'], unique=True, null=True))
        # Adding unique constraint on 'Wallet', fields ['user_profile']
        db.create_unique(u'SmartDataApp_wallet', ['user_profile_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Wallet', fields ['user_profile']
        db.delete_unique(u'SmartDataApp_wallet', ['user_profile_id'])


        # Changing field 'Wallet.user_profile'
        db.alter_column(u'SmartDataApp_wallet', 'user_profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.ProfileDetail'], null=True))
