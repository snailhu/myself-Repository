...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Fees'
        db.create_table(u'SmartDataApp_fees', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('price', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=19, decimal_places=3)),
        ))
        db.send_create_signal(u'SmartDataApp', ['Fees'])

        # Adding model 'Park_fee'
        db.create_table(u'SmartDataApp_park_fee', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.ProfileDetail'], null=True)),
            ('car_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('valid_time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal(u'SmartDataApp', ['Park_fee'])
    ...
    def backwards(self, orm):
        # Deleting model 'Fees'
        db.delete_table(u'SmartDataApp_fees')

        # Deleting model 'Park_fee'
        db.delete_table(u'SmartDataApp_park_fee')
    ...
    models = {
        ...
        u'SmartDataApp.park_fee': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'valid_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True'})
        },
