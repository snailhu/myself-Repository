...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfileDetail.floor'
        db.add_column(u'SmartDataApp_profiledetail', 'floor',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)

        # Adding field 'ProfileDetail.gate_card'
        db.add_column(u'SmartDataApp_profiledetail', 'gate_card',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)

        # Adding field 'ProfileDetail.address'
        db.add_column(u'SmartDataApp_profiledetail', 'address',
    ...
    def backwards(self, orm):
        # Deleting field 'ProfileDetail.floor'
        db.delete_column(u'SmartDataApp_profiledetail', 'floor')

        # Deleting field 'ProfileDetail.gate_card'
        db.delete_column(u'SmartDataApp_profiledetail', 'gate_card')

        # Deleting field 'ProfileDetail.address'
        db.delete_column(u'SmartDataApp_profiledetail', 'address')
