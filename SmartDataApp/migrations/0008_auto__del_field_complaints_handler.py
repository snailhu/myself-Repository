...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Complaints.handler'
        raise RuntimeError("Cannot reverse this migration. 'Complaints.handler' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Complaints.handler'
        db.add_column(u'SmartDataApp_complaints', 'handler',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.ProfileDetail']),
                      keep_default=False)
    ...
    models = {
        ...
        u'SmartDataApp.complaints': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pleased': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
