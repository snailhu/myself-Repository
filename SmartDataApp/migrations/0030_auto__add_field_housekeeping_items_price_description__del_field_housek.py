...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Housekeeping_items.price_description'
        db.add_column(u'SmartDataApp_housekeeping_items', 'price_description',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Deleting field 'Housekeeping.price'
        db.delete_column(u'SmartDataApp_housekeeping', 'price')

        # Deleting field 'Housekeeping.content'
        db.delete_column(u'SmartDataApp_housekeeping', 'content')

        # Deleting field 'Housekeeping.item'
        db.delete_column(u'SmartDataApp_housekeeping', 'item')

        # Deleting field 'Housekeeping.remarks'
        db.delete_column(u'SmartDataApp_housekeeping', 'remarks')

        # Adding field 'Housekeeping.housekeeping_item'
        db.add_column(u'SmartDataApp_housekeeping', 'housekeeping_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.Housekeeping_items'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Housekeeping_items.price_description'
        db.delete_column(u'SmartDataApp_housekeeping_items', 'price_description')

        # Adding field 'Housekeeping.price'
        db.add_column(u'SmartDataApp_housekeeping', 'price',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Housekeeping.content'
        db.add_column(u'SmartDataApp_housekeeping', 'content',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding field 'Housekeeping.item'
        db.add_column(u'SmartDataApp_housekeeping', 'item',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding field 'Housekeeping.remarks'
        db.add_column(u'SmartDataApp_housekeeping', 'remarks',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Deleting field 'Housekeeping.housekeeping_item'
        db.delete_column(u'SmartDataApp_housekeeping', 'housekeeping_item_id')
