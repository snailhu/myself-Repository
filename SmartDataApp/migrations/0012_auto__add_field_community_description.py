...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Community.description'
        db.add_column(u'SmartDataApp_community', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Community.description'
        db.delete_column(u'SmartDataApp_community', 'description')
