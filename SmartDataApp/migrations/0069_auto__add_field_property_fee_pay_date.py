...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Property_fee.pay_date'
        db.add_column(u'SmartDataApp_property_fee', 'pay_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Property_fee.pay_date'
        db.delete_column(u'SmartDataApp_property_fee', 'pay_date')
