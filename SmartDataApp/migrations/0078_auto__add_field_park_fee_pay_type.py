...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Park_fee.pay_type'
        db.add_column(u'SmartDataApp_park_fee', 'pay_type',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Park_fee.pay_type'
        db.delete_column(u'SmartDataApp_park_fee', 'pay_type')
