...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notification.notification_content'
        db.alter_column(u'SmartDataApp_notification', 'notification_content', self.gf('django.db.models.fields.CharField')(max_length=100000, null=True))

    def backwards(self, orm):

        # Changing field 'Notification.notification_content'
        db.alter_column(u'SmartDataApp_notification', 'notification_content', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
