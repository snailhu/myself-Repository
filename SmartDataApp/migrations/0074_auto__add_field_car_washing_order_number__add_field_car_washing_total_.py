...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Car_Washing.order_number'
        db.add_column(u'SmartDataApp_car_washing', 'order_number',
    ...
    def backwards(self, orm):
        # Deleting field 'Car_Washing.order_number'
        db.delete_column(u'SmartDataApp_car_washing', 'order_number')
