...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Complaints.timestamp'
        db.alter_column(u'SmartDataApp_complaints', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Complaints.timestamp'
        db.alter_column(u'SmartDataApp_complaints', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())
