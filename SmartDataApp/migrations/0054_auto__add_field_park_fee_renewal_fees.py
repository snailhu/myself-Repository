...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Park_fee.renewal_fees'
        db.add_column(u'SmartDataApp_park_fee', 'renewal_fees',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Park_fee.renewal_fees'
        db.delete_column(u'SmartDataApp_park_fee', 'renewal_fees')
    ...
    models = {
        ...
        u'SmartDataApp.park_fee': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'park_type': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
