...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'SmartDataApp_community', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
        ))
        db.send_create_signal(u'SmartDataApp', ['Community'])

        # Adding field 'ProfileDetail.community'
        db.add_column(u'SmartDataApp_profiledetail', 'community',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'SmartDataApp_community')

        # Deleting field 'ProfileDetail.community'
        db.delete_column(u'SmartDataApp_profiledetail', 'community_id')
