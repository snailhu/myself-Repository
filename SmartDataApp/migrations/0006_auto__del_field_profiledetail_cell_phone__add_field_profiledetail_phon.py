...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProfileDetail.cell_phone'
        db.delete_column(u'SmartDataApp_profiledetail', 'cell_phone')

        # Adding field 'ProfileDetail.phone_number'
        db.add_column(u'SmartDataApp_profiledetail', 'phone_number',
                      self.gf('django.db.models.fields.CharField')(max_length=11, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProfileDetail.cell_phone'
        db.add_column(u'SmartDataApp_profiledetail', 'cell_phone',
                      self.gf('django.db.models.fields.CharField')(max_length=11, null=True),
                      keep_default=False)

        # Deleting field 'ProfileDetail.phone_number'
        db.delete_column(u'SmartDataApp_profiledetail', 'phone_number')
