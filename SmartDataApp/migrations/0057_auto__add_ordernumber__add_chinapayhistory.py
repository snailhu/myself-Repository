...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderNumber'
        db.create_table(u'SmartDataApp_ordernumber', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('number', self.gf('django.db.models.fields.CharField')(default=u'0000000001', max_length=10, null=True)),
        ))
        db.send_create_signal(u'SmartDataApp', ['OrderNumber'])

        # Adding model 'ChinaPayHistory'
        db.create_table(u'SmartDataApp_chinapayhistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('version', self.gf('django.db.models.fields.CharField')(default=u'1.0.0', max_length=20, null=True)),
            ('charset', self.gf('django.db.models.fields.CharField')(default=u'UTF-8', max_length=20, null=True)),
            ('sign_method', self.gf('django.db.models.fields.CharField')(default=u'MD5', max_length=20, null=True)),
            ('signature', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('trans_type', self.gf('django.db.models.fields.CharField')(default=u'01', max_length=20, null=True)),
            ('resp_code', self.gf('django.db.models.fields.CharField')(default='00', max_length=20, null=True)),
            ('resp_msg', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('mer_abbr', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
            ('mer_id', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
            ('order_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('trance_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('trace_time', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('qid', self.gf('django.db.models.fields.CharField')(max_length=30, null=True)),
            ('order_amount', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('order_currency', self.gf('django.db.models.fields.CharField')(default=u'156', max_length=20, null=True)),
            ('resp_time', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
            ('settle_amount', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('settle_currency', self.gf('django.db.models.fields.CharField')(default=u'156', max_length=250, null=True)),
            ('settle_date', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('exchange_rate', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('exchange_date', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('cup_reserved', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
        ))
        db.send_create_signal(u'SmartDataApp', ['ChinaPayHistory'])


    def backwards(self, orm):
        # Deleting model 'OrderNumber'
        db.delete_table(u'SmartDataApp_ordernumber')

        # Deleting model 'ChinaPayHistory'
        db.delete_table(u'SmartDataApp_chinapayhistory')


    models = {
        u'SmartDataApp.chinapayhistory': {
            'Meta': {'object_name': 'ChinaPayHistory'},
            'charset': ('django.db.models.fields.CharField', [], {'default': "u'UTF-8'", 'max_length': '20', 'null': 'True'}),
            ...
            'mer_abbr': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True'}),
            'mer_id': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True'}),
            'order_amount': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True'}),
            'order_currency': ('django.db.models.fields.CharField', [], {'default': "u'156'", 'max_length': '20', 'null': 'True'}),
            'order_number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            'qid': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True'}),
            'resp_code': ('django.db.models.fields.CharField', [], {'default': "'00'", 'max_length': '20', 'null': 'True'}),
            'resp_msg': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            'resp_time': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True'}),
            'settle_amount': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True'}),
            'settle_currency': ('django.db.models.fields.CharField', [], {'default': "u'156'", 'max_length': '250', 'null': 'True'}),
            'settle_date': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True'}),
            'sign_method': ('django.db.models.fields.CharField', [], {'default': "u'MD5'", 'max_length': '20', 'null': 'True'}),
            'signature': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            'trace_time': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True'}),
            'trance_number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            'trans_type': ('django.db.models.fields.CharField', [], {'default': "u'01'", 'max_length': '20', 'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True'}),
            'version': ('django.db.models.fields.CharField', [], {'default': "u'1.0.0'", 'max_length': '20', 'null': 'True'})
        },
        ...
        u'SmartDataApp.ordernumber': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.CharField', [], {'default': "u'0000000001'", 'max_length': '10', 'null': 'True'})
        },
