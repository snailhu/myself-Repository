...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'car_washing'
        db.create_table(u'SmartDataApp_Car_Washing', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SmartDataApp.ProfileDetail'], null=True)),
            ('apply_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('washing_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('washing_case', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('other_car_num', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('washing_status', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'SmartDataApp', ['car_washing'])


    def backwards(self, orm):
        # Deleting model 'car_washing'
        db.delete_table(u'SmartDataApp_Car_Washing')
