...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChinaPayHistory.settle_daount'
        db.delete_column(u'SmartDataApp_chinapayhistory', 'settle_daount')

        # Deleting field 'ChinaPayHistory.order_amrrency'
        db.delete_column(u'SmartDataApp_chinapayhistory', 'order_amrrency')

        # Deleting field 'ChinaPayHistory.trans_type'
        db.delete_column(u'SmartDataApp_chinapayhistory', 'trans_type')

        # Deleting field 'ChinaPayHistory.settle_cute'
        db.delete_column(u'SmartDataApp_chinapayhistory', 'settle_cute')

        # Adding field 'ChinaPayHistory.trance_type'
        db.add_column(u'SmartDataApp_chinapayhistory', 'trance_type',
                      self.gf('django.db.models.fields.CharField')(default=u'01', max_length=20, null=True),
                      keep_default=False)

        # Adding field 'ChinaPayHistory.order_amount'
        db.add_column(u'SmartDataApp_chinapayhistory', 'order_amount',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding field 'ChinaPayHistory.settle_currency'
        db.add_column(u'SmartDataApp_chinapayhistory', 'settle_currency',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding field 'ChinaPayHistory.settle_date'
        db.add_column(u'SmartDataApp_chinapayhistory', 'settle_date',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)


        # Changing field 'ChinaPayHistory.order_currency'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'order_currency', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):
        # Adding field 'ChinaPayHistory.settle_daount'
        db.add_column(u'SmartDataApp_chinapayhistory', 'settle_daount',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding field 'ChinaPayHistory.order_amrrency'
        db.add_column(u'SmartDataApp_chinapayhistory', 'order_amrrency',
                      self.gf('django.db.models.fields.CharField')(default=u'156', max_length=250, null=True),
                      keep_default=False)

        # Adding field 'ChinaPayHistory.trans_type'
        db.add_column(u'SmartDataApp_chinapayhistory', 'trans_type',
                      self.gf('django.db.models.fields.CharField')(default=u'01', max_length=20, null=True),
                      keep_default=False)

        # Adding field 'ChinaPayHistory.settle_cute'
        db.add_column(u'SmartDataApp_chinapayhistory', 'settle_cute',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Deleting field 'ChinaPayHistory.trance_type'
        db.delete_column(u'SmartDataApp_chinapayhistory', 'trance_type')

        # Deleting field 'ChinaPayHistory.order_amount'
        db.delete_column(u'SmartDataApp_chinapayhistory', 'order_amount')

        # Deleting field 'ChinaPayHistory.settle_currency'
        db.delete_column(u'SmartDataApp_chinapayhistory', 'settle_currency')

        # Deleting field 'ChinaPayHistory.settle_date'
        db.delete_column(u'SmartDataApp_chinapayhistory', 'settle_date')


        # Changing field 'ChinaPayHistory.order_currency'
        db.alter_column(u'SmartDataApp_chinapayhistory', 'order_currency', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        ...
        u'SmartDataApp.chinapayhistory': {
            ...
            'trance_type': ('django.db.models.fields.CharField', [], {'default': "u'01'", 'max_length': '20', 'null': 'True'}),
