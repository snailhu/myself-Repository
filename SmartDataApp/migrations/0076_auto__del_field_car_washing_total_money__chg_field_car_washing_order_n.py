...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Car_Washing.total_money'
        db.delete_column(u'SmartDataApp_car_washing', 'total_money')


        # Changing field 'Car_Washing.order_number'
        db.alter_column(u'SmartDataApp_car_washing', 'order_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):
        # Adding field 'Car_Washing.total_money'
        db.add_column(u'SmartDataApp_car_washing', 'total_money',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=6, decimal_places=2),
                      keep_default=False)


        # Changing field 'Car_Washing.order_number'
        db.alter_column(u'SmartDataApp_car_washing', 'order_number', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))
    ...
    models = {
        u'SmartDataApp.car_washing': {
            ...
            'order_number': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True'}),
        ...
        u'SmartDataApp.fee_standard': {
            ...
            'deadline': ('django.db.models.fields.DateField', [], {'default': '0', 'null': 'True'}),
        ...
        u'SmartDataApp.park_fee': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_number': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True'}),
            'park_type': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True'}),
            'pay_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'position_num': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        u'SmartDataApp.property_fee': {
            ...
            'remind_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'send_message': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'send_remind_message': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True'}),
            'valid_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True'})
        },
